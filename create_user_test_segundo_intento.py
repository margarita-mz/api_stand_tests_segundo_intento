import sender_stand_request_segundo_intento
...
def get_user_body(first_name):
    ...
    current_body = data_segundo_intento.user_body.copy()
...
def positive_assert(first_name):
    ...
    user_response = sender_stand_request_segundo_intento.post_new_user(user_body)
    ...
    users_table_response = sender_stand_request_segundo_intento.get_users_table()
...
def negative_assert_symbol(first_name):
    ...
    response = sender_stand_request_segundo_intento.post_new_user(user_body)
...
def test_create_user_no_first_name_get_error_response():
    ...
    user_body = data_segundo_intento.user_body.copy()
